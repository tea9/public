...
import com.demo.android_ds.util.Rom;
...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        Bugly.init(getApplicationContext(), "8efd5f90aa", false);
        OkGo.getInstance().init(this);
        //check手机

        Log.e("hhhhh", String.valueOf(Rom.isMiui()));
        Log.e("hhhhh", String.valueOf(Rom.isEmui()));
        Log.e("hhhhh", String.valueOf(Rom.isMiui()));
        Log.e("hhhhh", App.getDeviceBrand());
