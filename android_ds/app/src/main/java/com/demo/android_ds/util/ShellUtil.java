...
public class ShellUtil {
    ...
    /**
     * 强制停止进程
     * @param package_activity
     */
    public static void stopActivity(String package_activity) {
        //com.songheng.eastnews/com.oa.eastfirst.activity.WelcomeActivity
        //adb shell am force-stop com.songheng.eastnews
        RootCmd.execRootCmd("am force-stop " + package_activity); // 打开app
    }
...
//        adb shell input keyevent 93 #向下翻页键
    ...
    public static void clearXiaoMi() throws InterruptedException {
        RootCmd.execRootCmd("input keyevent 82"); //菜单
        Thread.sleep(600);
        ShellUtil.clickByXy("com.android.systemui:id/clearAnimView",Constant.FILE_PATH);
        Thread.sleep(500);
    }

    public static void clearLeShi() throws InterruptedException{
//        RootCmd.execRootCmd("input keyevent 82"); //菜单
        Thread.sleep(500);
        ShellUtil.clickByXy("com.android.systemui:id/clearAnimView",Constant.FILE_PATH);
        Thread.sleep(500);
    ...
    public static void slideByXyIds2(String res_id, String file_path) throws InterruptedException {
        ...
        if (aa != null) {
            for (int i = 0; i < aa.size(); i++) {
                ...
                int j = 0;
                while (j<23) {
                    Log.e(Constant.TAG,"shellutil在滑动");
