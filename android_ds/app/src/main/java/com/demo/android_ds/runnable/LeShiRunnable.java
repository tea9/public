 ...
 */
public class LeShiRunnable implements Runnable, BaseRunnable {
    // 开始停止标志位
...
//        } else if (nowDate >= 22 && nowDate <= 24) {
    ...
    @Override
    public void run() {
        Log.e(TAG, "LeShiRunnable" + Thread.currentThread().getName() + "AAA1" + index);
        //在这里判断时间 12小时 执行 a b
        checkTimeLimit();
...
//            entity.flag_enum = Constant.ENUM.TUTOUTIAO;
            if (entity.flag_enum == Constant.ENUM.ZHIMATOUTIAO) { // 芝麻头条
                ...
                if (checkTime(startTime)) {
                    try {
                        start(Constant.DongFang.ACTIVITY_PACKAGE,Constant.DongFang.PACKAGE_NAME);
...
//                        }
                ...
                if (checkTime(startTime)) {
                    try {
                        start(Constant.HuiTouTiao.ACTIVITY_PACKAGE,Constant.HuiTouTiao.PACKAGE_NAME);
                        Thread.sleep(3 * 1000);
...
//                                ShellUtil.swipe(990,550);
                            slideByXyIdsNotQuTouTiao(80, 869, startTime); // 第一条是置顶
                        }
//                        } else {
...
//                        }
                ...
                if (checkTime(startTime)) {
                    try {
                        ...
                        Thread.sleep(2 * 1000);
                        ShellUtil.clickMethod(489, 453); // 签到
...
//                        }
                ...
                if (checkTime(startTime)) {
                    try {
                        start(Constant.TouTiaoDuoDuo.ACTIVITY_PACKAGE,Constant.TouTiaoDuoDuo.PACKAGE_NAME);
                        ...
                        Thread.sleep(3000);
                        // check 红包
                        Log.e(Constant.TAG, "头条多多  点击btn1");
...
//                            slideByXyIds2TouTiaoDuoDuo(Constant.TouTiaoDuoDuo.RES_ID_ITEM11, Constant.TouTiaoDuoDuo.FileName.file_path1, startTime, 1); // 文章需要滑到底
                            slideByXyIds2TouTiaoDuoDuo(81,1532, startTime); // 文章需要滑到底
//                                Thread.sleep(2 *1000);
//                            ShellUtil.clickByXy(Constant.TouTiaoDuoDuo.RES_ID_BTN11, Constant.TouTiaoDuoDuo.FileName.file_path1); // 点击刷新
                            ShellUtil.clickMethod(126,1863);
                            Thread.sleep(4000);
...
//                        }
                ...
                if (checkTime(startTime)) {
                    try {
                        ...
                        start(Constant.Browser2345.ACTIVITY_PACKAGE,Constant.Browser2345.PACKAGE_NAME);
                        Thread.sleep(4000);
...
//            ShellUtil.back();
                        ...
                        ShellUtil.clickMethod(923, 149); //领钱
                        Thread.sleep(1000);
...
//                            ShellUtil.clickByXy(Constant.Browser2345.RES_ID_BTN1, Constant.Browser2345.FileName.file_path1); // 点击刷新
                            ShellUtil.clickMethod(112,1866);
                            Thread.sleep(2000);
...
//                            slideByXyIds4Brower2345(Constant.Browser2345.RES_ID_ITEM1, Constant.Browser2345.FileName.file_path1, startTime); // 第一条是置顶
                            slideByXyIds4Brower2345(78,421,startTime);
                        }
//                        } else {
...
//                        ShellUtil.clickByXy(Constant.WeiLiKanKan.RES_ID_BTN2222, Constant.WeiLiKanKan.FileName.file_path1); // 签到
                        ShellUtil.clickMethod(935, 1850); //我的
                        Thread.sleep(2000);
                        ShellUtil.clickMethod(538, 1678); //弹框
                        Log.e(Constant.TAG, "微鲤看看 我的");
                        Thread.sleep(2000);
                        ShellUtil.clickMethod(902, 391); //签到
...
//                        }
                ...
                if (checkTime15(startTime)) {
                    try {
                        start(Constant.JiuCaiZiXun.ACTIVITY_PACKAGE,Constant.JiuCaiZiXun.PACKAGE_NAME);
                        Thread.sleep(3 * 1000);
...
//                        }
                ...
                if (checkTime(startTime)) {
                    try {
                        start(Constant.HongBaoTouTiao.ACTIVITY_PACKAGE,Constant.HongBaoTouTiao.PACKAGE_NAME);
                        ShellUtil.clickMethod(638, 1866); // 任务
                        Thread.sleep(1000);
                        ShellUtil.clickMethod(854, 429); //签到
                        Thread.sleep(4 * 1000);
                        ...
                        while ((checkTime(startTime))) {
                            ...
                            slideByXyIds5HongBaoTouTiao(120, 1357, startTime);
                        }
...
//                        }
                ...
                //endregion
            } else if (entity.flag_enum == Constant.ENUM.XINTOUTIAO) {//新头条 收不到验证码
                //region xintoutiao
                if (checkTime(startTime)) {
                    try {
...
//                            }
                ...
                if (checkTime(startTime)) {
                    try {
                        start(Constant.DaZhongKanDian.ACTIVITY_PACKAGE,Constant.DaZhongKanDian.PACKAGE_NAME);
                        Thread.sleep(3 * 1000);
...
//                        }
                ...
                if (checkTime(startTime)) {
                    try {
                        start(Constant.YinLiZiXun.ACTIVITY_PACKAGE,Constant.YinLiZiXun.PACKAGE_NAME);
                        Thread.sleep(3 * 1000);
                        ShellUtil.clickMethod(546,1549);
...
//                        }
                ...
                if (checkTime(startTime)) {
                    try {
                        ...
                        start(Constant.ZhangShangTouTiao.ACTIVITY_PACKAGE,Constant.ZhangShangTouTiao.PACKAGE_NAME);
                        Thread.sleep(1 * 1000);
...
//                        }
                ...
                if (checkTime10(startTime)) {
                    try {
                        start(Constant.DianDianXinWen.ACTIVITY_PACKAGE,Constant.DianDianXinWen.PACKAGE_NAME);
                        Thread.sleep(1 * 1000);
                        Log.e(Constant.TAG, "返回");
                        ShellUtil.back();
                        Thread.sleep(2 * 1000);
...
//                        }
                ...
                if (checkTime(startTime)) {
                    try {
                        start(Constant.ShanDianKanKan.ACTIVITY_PACKAGE,Constant.ShanDianKanKan.PACKAGE_NAME);
                        Thread.sleep(10 * 1000);
...
//                            }
                ...
                if (checkTime(startTime)) {
                    try {
                        start(Constant.TuTouTiao.ACTIVITY_PACKAGE,Constant.TuTouTiao.PACKAGE_NAME);
                        Thread.sleep(5 * 1000);
...
//                            ShellUtil.clickMethod(103,460); //第一条
    ...
    private void start(String activity_name,String package_name) throws InterruptedException {
        //region start
        Log.e(TAG, "start home" + Thread.currentThread().getName());
        ShellUtil.home();
        Thread.sleep(500);
        Log.e(TAG, "start clear" + Thread.currentThread().getName());
//        ShellUtil.clearLeShi();
        ShellUtil.stopActivity(package_name);
        Thread.sleep(2000);
    ...
    private void start(String activity_name) throws InterruptedException {
        ...
        Log.e(TAG, "start clear" + Thread.currentThread().getName());
//        ShellUtil.clearLeShi();
        ShellUtil.stopActivity(activity_name);
        Thread.sleep(2000);
        Log.e(TAG, "start startActivity" + Thread.currentThread().getName());
        ShellUtil.startActivity(activity_name);
        Log.e(TAG, "start startActivity ssss" + Thread.currentThread().getName());
...
//        }
    ...
    private void beforeQuTouTiao() throws InterruptedException {
        ...
        start(Constant.QuTouTiao.ACTIVITY_PACKAGE,Constant.QuTouTiao.PACKAGE_NAME);
        Thread.sleep(5 * 1000);
    }
...
//        }
    ...
    private void beforeMaYiTouTiao() throws InterruptedException {
        start(Constant.MaYi.ACTIVITY_PACKAGE,Constant.MaYi.PACKAGE_NAME);
//        ShellUtil.startActivity(Constant.MaYi.ACTIVITY_PACKAGE);
        Thread.sleep(10 * 1000);
        ShellUtil.clickByXy(Constant.MaYi.RES_ID_RED, Constant.MaYi.FileName.file_path1); // 红包
    ...
    private void slideByXyIdsMAYI(String res_id, String file_path, long startTime) throws InterruptedException {
        Log.e(Constant.TAG, "mayi  keyevent 1");
        ShellUtil.createXMLFile(file_path);
        Log.e(Constant.TAG, "mayi keyevent 1");
        ...
        if (aa != null) {
            ...
            Log.e(Constant.TAG, "mayi keyevent 1");
            Thread.sleep(2 * 1000);
            Log.e(Constant.TAG, "mayi keyevent 2");
            // 滑动
            int j = 0;
            while (j < 20 && (checkTime(startTime))) {
                Log.e(Constant.TAG, "mayi swipe 25 1050 25 450 700");
...
//                Thread.sleep(2 * 1000);
    ...
    private void slideByXyIds2TouTiaoDuoDuo(int x1,int y1, long startTime) throws InterruptedException {
...
//                    }
    ...
    private void slideByXyIds4Brower2345(int x1,int y1 ,long startTime) throws InterruptedException {
...
//        }
    ...
    private void beforeWeiLiKanKan() throws InterruptedException {
        start(Constant.WeiLiKanKan.ACTIVITY_PACKAGE,Constant.WeiLiKanKan.PACKAGE_NAME);
        Thread.sleep(3 * 1000);
...
//                Log.e(Constant.TAG,"keyevent 2");
    ...
    private boolean openActivityXinTouTiao(boolean flag) throws InterruptedException {
        ...
        start(Constant.XinTouTiao.ACTIVITY_PACKAGE,Constant.XinTouTiao.ACTIVITY_PACKAGE);
        Thread.sleep(6 * 1000);
