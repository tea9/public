package com.demo.android_ds.ui.view;
...
/**
 *
 * https://www.jianshu.com/p/9f3363c5df62
 */
public class SmoothCheckBox extends View implements View.OnClickListener {
    ...
    public SmoothCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        borderColor = a.getColor(R.styleable.SmoothCheckBox_borderColor,getResources().getColor(R.color.yellow));
        trimColor = a.getColor(R.styleable.SmoothCheckBox_trimColor, getResources().getColor(R.color.yellow));
    ...
    public void setChecked2(boolean isChecked) {
