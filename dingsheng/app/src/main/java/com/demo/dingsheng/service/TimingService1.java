 ...
 * 来电检测 设置
 */
public class TimingService1 extends Service {
    ...
    private void start1(){
        ...
        runnable4 = new Runnable() {
            ...
            public void run() {
                ...
                showToastByRunnable(TimingService1.this,"index"+index);
...
//                            Toast.makeText(getApplicationContext(), "position " + position + " title:" + title + " is clicked.", Toast.LENGTH_SHORT).show();
                            ...
                            if (position == 0) {
                                showToastByRunnable(TimingService1.this, "正在启动");
                                SharedPreferencesUtils.putInfo(getApplicationContext(), Constant.START_CMD, true);
                                startTimer1();
                                startTimer2();
                                startTimer3();
                                ...
                                try {
                                    showToastByRunnable(TimingService1.this, "正在停止");
                                    SharedPreferencesUtils.putInfo(getApplicationContext(), Constant.START_CMD, false);
                                    stopTimer();
                                } catch (Exception e){
