...
public final class RootCmd {
    ...
    public static String execRootCmd(String cmd) {
        boolean start_cmd= SharedPreferencesUtils.getPreferences(App.mContext).getBoolean(Constant.START_CMD,true);
//        if (start_cmd) {
        if (start_cmd&&!Thread.currentThread().isInterrupted()) {
            String result = "";
