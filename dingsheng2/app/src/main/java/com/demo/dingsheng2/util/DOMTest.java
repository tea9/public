...
//        Map<String, Integer> xx =getCoordinateWithText("抱歉","/Users/shaomiao/Desktop/zz.xml");
...
//        System.out.println(coordinateWithResourceId);
        ...
        Map<String, Map<String, Integer>> xx = getCoordinateWithTextHongbaoTouTiao("com.martian.hbnews:id/news_summary_title_tv", "/Users/shaomiao/Desktop/ss.xml");
        System.out.println("shaomiao"+xx);
    }

    public static Map<String, Map<String, Integer>> getCoordinateWithTextHongbaoTouTiao(String id, String fileUrl) {
        int index = 0;
...
//                        System.out.println(String.valueOf(getChildCoordnate(attrs.getNamedItem("bounds").getNodeValue())));
                        NamedNodeMap attributes = node.item(i + 2).getAttributes();
                        NamedNodeMap attributes1 = node.item(i + 4).getAttributes();
                        if (!attributes.getNamedItem("text").getNodeValue().equals("头条推荐")&&!attributes.getNamedItem("text").getNodeValue().equals("广告")&&!attributes1.getNamedItem("text").getNodeValue().equals("广告")) {
    ...
    public static Map<String, Map<String, Integer>> getCoordinateWithTextZhongQing(String id, String fileUrl) {
        int index = 0;
        Map<String, Map<String, Integer>> childCoordnate = new HashMap<>();
        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
        try {
            ...
            for (int i = 0; i < bookCnt; i++) {
                ...
                for (int j = 0; j < attrs.getLength(); j++) {
                    if (attrs.getNamedItem("resource-id").getNodeValue().equals(id)) {
                        System.out.println(String.valueOf(getChildCoordnate(attrs.getNamedItem("bounds").getNodeValue())));
                        NamedNodeMap attributes = node.item(i + 6).getAttributes();
                        if (!attributes.getNamedItem("text").getNodeValue().equals("头条推荐")&&!attributes.getNamedItem("text").getNodeValue().equals("广告")) {
                            childCoordnate.put(index + "", getChildCoordnate(attrs.getNamedItem("bounds").getNodeValue()));
                            index++;
                        }
                        break;
    ...
    public static Map<String, Map<String, Integer>> getCoordinateWithTextXinTouTiao(String id, String fileUrl) {
        int index = 0;
        Map<String, Map<String, Integer>> childCoordnate = new HashMap<>();
        DocumentBuilderFactory dbf = DocumentBuilderFactory.newInstance();
        try {
            ...
            for (int i = 0; i < bookCnt; i++) {
                ...
                for (int j = 0; j < attrs.getLength(); j++) {
                    if (attrs.getNamedItem("resource-id").getNodeValue().equals(id)) {
                        System.out.println(String.valueOf(getChildCoordnate(attrs.getNamedItem("bounds").getNodeValue())));
                        NamedNodeMap attributes = node.item(i + 26).getAttributes();
