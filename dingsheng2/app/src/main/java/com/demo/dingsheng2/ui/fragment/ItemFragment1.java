...
import com.demo.dingsheng2.service.AllService2;
import com.demo.dingsheng2.ui.adapter.FmPagerAdapter;
...
//                    context.startService(z);
             ...
             //存数据
             List<TabEntity> beforelist = TabFragment1.list.subList(0, 7);//多加了一个

             List<TabEntity> afterlist = TabFragment1.list.subList(8, TabFragment1.list.size());
...
//        SharedPreferencesUtils.putInfo(context, Constant.ALL_TEXT, GsonUtil.createGsonString(TabFragment1.list));
             ...
             context.startService(new Intent(context, AllService2.class));
         }
    }
